    ...
    async destroyAll() {
        try {
            ...
            for (const {table_name} of rows) {
                await this.client.query(`DROP TABLE IF EXISTS "${table_name}" CASCADE`);
...
//
    createAllTable() {
        ...
        this.client.query(` CREATE TABLE IF NOT EXISTS "cards" (
        ...
        this.client.query(` CREATE TABLE IF NOT EXISTS "shop" (
            id SERIAL PRIMARY KEY,
        ...
        this.client.query(` CREATE TABLE IF NOT EXISTS "cooldown_reward" (
