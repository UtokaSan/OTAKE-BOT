...
function getComparator(order, orderBy) {
    return (a, b) => {
        ...
        if (orderBy === 'rarity') {
            comparator = getRarityOrder(a.rarity) - getRarityOrder(b.rarity);
        } else if (orderBy === 'attack' || orderBy === 'pv' || orderBy === 'price') {
            comparator = a[orderBy] - b[orderBy];
        }

        if (order === 'desc') comparator = -comparator;
